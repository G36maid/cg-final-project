...
\begin{figure}[H]
  ...
  \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/theme-park-hub.png}
    \captionof{figure}{Dusk Park hub (third-person view): the dusk-gradient skybox, the
    reflecting fountain, neon building facades, and long sun shadows across the stone
    plaza.}
  \end{minipage}
\end{figure}
