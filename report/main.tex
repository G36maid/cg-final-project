...
The meta-game itself is a first-person walkthrough scene that concentrates every hard graphics
...
(the meta-game) and the game universes behind each door, and the warm light makes every graphics
...
The insight that turned four demos into one game was the \textbf{theme-park meta-game}. Instead
...
universe, connected by a shared token economy and a persistent save state. The meta-game then
...
physics, rendering, and gameplay untouched, and the meta-game glued them together with nothing
